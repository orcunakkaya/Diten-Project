...
const secondTableReducer = (state = initialState, action) => {
    switch (action.type) {
        case actionTypes.TABLE_SECOND_DRAG_AND_DROP:
        ...
        case actionTypes.TABLE_SECOND_PIN:
...
export default secondTableReducer;