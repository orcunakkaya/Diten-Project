...
const firstTableReducer = (state = initialState, action) => {
    switch (action.type) {
        case actionTypes.TABLE_FIRST_DRAG_AND_DROP:
        ...
        case actionTypes.TABLE_FIRST_PIN:
            return (
...
export default firstTableReducer;